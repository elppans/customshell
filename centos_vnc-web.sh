...
ln -sf /usr/share/kanaka-noVNC/vnc.html /usr/share/kanaka-noVNC/index.html
...
/usr/bin/novnc --listen 6080 --vnc localhost:5900 --web /usr/share/kanaka-noVNC/ 2>&1 1>& /var/log/noVNC.log &
...
# Backup:
cd /opt
tar -zcf kanaka-novnc_git-`date +%d%m%y`.tgz /usr/share/kanaka-noVNC /usr/bin/novnc /usr/bin/x11vnc-browser /etc/systemd/system/x11vnc-browser.service
